        ...
        <div name='pricing' className='w-full text-white my-24 '>
            ...
            <div className='max-w-[1240px] mx-auto py-12 '>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <h3 className='text-5xl font-bold text-white py-8 '>The right price for your recharge.</h3>
                    <p className='text-3xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem architecto, hic omnis cumque aperiam quae quo dolores consequuntur quasi molestiae.</p>
                </div>
                ...
                <div className='grid md:grid-cols-2 '>
                    ...
                    <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                        ...
                        <p className='text-2xl py-8 text-slate-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit!</p>
                        <div className='text-2xl '>
                            <p className='flex py-4 '><CheckIcon className='w-8 mr-5 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4 '><CheckIcon className='w-8 mr-5 text-green-600' />Lorem ipsum dolor sit amet consectetur.</p>
                            <p className='flex py-4 '><CheckIcon className='w-8 mr-5 text-green-600' />Lorem ipsum dolor sit.</p>
